...
using RazorPages_AppEx.Data;
using System.Text;

namespace RazorPages_AppEx.Pages
{
    public class IndexModel : PageModel
    {
        ...
        {
            string path = Path.Combine(_environment.ContentRootPath, "Data/file.txt");
            var bytes =System.IO.File.ReadAllBytes(path);
            return File(bytes, "Application/text", "Salam.txt");
        }
